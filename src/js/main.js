...
var alaydisArr = ['breakfast', 'desserts', 'drinks', 'salads', 'sandwiches', 'sides', 'soups', 'toppings', 'veraDesserts']
...
export { baseURL, requestAPI, newsTemplate, fancyMenuTemplate, log, newsToPage};
